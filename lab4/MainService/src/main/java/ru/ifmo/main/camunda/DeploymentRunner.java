...
public class DeploymentRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        camundaDeploymentService.deployProcessDefinition(List.of("auth-process.bpmn", "register-process.bpmn", "verify-precess.bpmn", "create-rent-process.bpmn", "confirm-process.bpmn", "add-modey-process.bpmn"));
